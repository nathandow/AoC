...
data class Game(val id: Int, var red: Int = 0, var green: Int = 0, var blue: Int = 0) {
}

class Day2 {
    companion object {
        fun part1(file: String, r: Int = 0, g: Int = 0, b: Int = 0): Int {
        ...
        fun part2(file: String, r: Int = 0, g: Int = 0, b: Int = 0): Int {
        ...
        // Max colors needed for each game.
